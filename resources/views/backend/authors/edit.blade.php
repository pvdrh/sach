...
@section('header-content')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Cập nhật Tác giả</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="{{ route('backend.authors.update', $author->id) }}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên tác giả <span style="color: red"> *</span></label>
                                <input type="text" class="form-control" value="{{$author->name}}" placeholder="Tên nhà xuất bản" name="name">
                                @error('name')
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('backend.authors.index') }}"
