...
@section('header-content')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Thêm mới tác giả</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <form role="form" method="POST" action="{{ route('backend.authors.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('backend.authors.index')}}" class="btn btn-danger"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
