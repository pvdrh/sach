...
@section('header-content')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="card-title">Cập nhật Nhà xuất bản</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="{{ route('backend.publishings.update', $publish->id) }}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$publish->name}}"
                                       placeholder="Nhập tên nhà xuất bản" name="name">
                                @error('name')
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('backend.publishings.index') }}"
