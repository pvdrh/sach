        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" role="form" action="{{ route('backend.user.save') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Mật khẩu mới<span style="color: red"> *</span></label>
                                <input name="pass" type="text" class="form-control" id="" placeholder="Nhập mật khẩu">
                                @error('pass')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Xác nhận mật khẩu<span
                                        style="color: red"> *</span></label>
                                <input name="newPass" type="text" class="form-control" id=""
